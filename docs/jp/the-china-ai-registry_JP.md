...
日本語圏で「中国のAIモデル」が語られるとき、現れる名前はおおむねこの5つに収まる。<br/>
ベンチマークのスコアとAPI価格を横に並べた比較表が作られ、そこで議論が終わる。

この5社は実在する。性能も価格も、表の数字は正しい。

**問題は分母である。**

この5社は、中国のAI産業の何割を占めるのか。

表を作った側も、読んだ側も、この問いに答えられない。<br/>
**分母を知らないまま、分子だけを比べている。**

中国は不透明だから仕方ない——そう説明されることが多い。<br/>
だが、分母は推計する必要がない。<br/>
**中国当局が、個社名入りで公開している。**

**988。**<br/>
2026年6月30日時点で、備案（登録）を完了した生成AIサービスの累計件数である。

冒頭の5社は、この988件の中にある。<br/>
しかし、それ以外に983件が存在する。
...
中国で生成AIのサービスを提供するには、当局への登録が要る。

根拠は「生成式人工智能服务管理暂行办法」（Interim Measures for the Management of Generative AI Services／生成AIサービス管理暫定弁法）である。<br/>
この規則に基づき、中国国家インターネット情報弁公室（国家网信办 / Cyberspace Administration of China、以下CAC）は登録済みの情報を定期的に公告している。

先ほどの988に加えて、もう一つ数字がある。

**598。**<br/>
登記を完了した生成AIアプリケーションおよび機能の累計件数である。

この二つは推計ではない。<br/>
CACが2026年7月10日に公告した数字であり、公告文にはこう書かれている——<br/>
2026年5月から6月にかけて120件のサービスが新たに備案を完了し、68件のアプリケーションまたは機能が新たに登記を完了した、と。

CACのサイトには、2024年4月から2026年6月まで、**12回分の附件**（**添付ファイル**）が一枚のページに集約されている。<br/>
各附件には、序号・属地・大模型名称・備案単位・備案編号・備案時間の6列が並ぶ。<br/>
どの企業が、どの省で、いつ、どの名前のモデルを登録したのか。すべて書かれている。

更新の刻みは2ヶ月である。<br/>
2024年4月、8月、11月。2025年1月、3月、6月、8月、10月、12月。2026年2月、4月、5〜6月。

この名簿は、表現の管理を目的として作られたものだ。<br/>
産業振興のための統計ではない。<br/>
**しかし結果として、生成AIの社会実装を全数で追跡できる公的記録になっている。**

米国・EU・日本について、これに対応する公的記録を本書は確認できなかった。<br/>
どの企業が、どの業務に、いつAIを実装したのか。<br/>
**国単位で全数を追える記録として、本書が到達できたのはこの一国のものだけである。**

---

## なぜ、その5社なのか

では、988件のうちなぜあの5社が記事に現れるのか。
...
この三つを通過したものだけが、比較記事に現れる。<br/>
通過しなかったものは、**存在ごと記事から消える。**

つまり、あの5社は「中国のAIモデルの代表」ではない。<br/>
**「海外から観測できる中国のAIモデル」である。** <br/>
選抜ではなく、フィルタの出力である。

---

## フィルタを通過しなかった側に、何があるか

では、消えている983件には何があるのか。

* **製鉄所の転炉制御。**
河北永洋特鋼集団（Hebei Yongyang Special Steel）が「転炉智能煉鋼大模型」を登録している。

* **鉱山の安全生産管理。**
磁県鑫盛煤化工が「安全生産管控大模型」を登録している。

* **水道局のコールセンター。**
北京市自来水集団（Beijing Waterworks Group）が「京水客服」を登録している。

* **市民ホットライン。**
北京市市民熱線服務中心が「12345智能体」を登録している。

* **褥瘡の管理支援。**
江蘇省人民医院（Jiangsu Province Hospital）が「舒圧伴・PressGuard」を登録している。

* **災害対応。**
応急管理部（Ministry of Emergency Management）の大数据中心が「久安-知言」「久安-知図」の2件を登録している。

石油。天然ガス管網。電力。航空。物流。アルミ。<br/>
**国家インフラの基幹企業が、自前の大規模モデルを登録している。**

外資も同じ名簿にいる。<br/>
**テスラ上海**（序号843）。**IKEA中国**（序号825）。**シーメンス中国**（序号674）。**コカ・コーラ上海**（序号877）。**BMW中国**（序号912）。**ASUS上海**（序号823）。

これらは一つも、APIとして海外に提供されていない。<br/>
重みも配布されていない。英語の資料もない。<br/>
**社外に売っていないからである。**

比較表に載らないのは当然である。<br/>
**比較の対象になりようがない。**

そして同時に、これらは**生成AIが実際にどの業務に入ったかを示す、最も具体的な記録**でもある。

対話アシスタントでも社内文書検索でもない。<br/>
**プロセスと公共サービスそのものだ。**
...
**一つ目は、自業界の実装事例である。** <br/>
第4章で、988件を業種別に整理する。<br/>
製造・エネルギー・医療・公共・物流・金融・教育。<br/>
**自分の業界で、生成AIが実際にどの業務に入っているかを、社名とモデル名のレベルで引ける。**

**二つ目は、中国市場に出すときの実務の先例である。**<br/>
テスラ・IKEA・シーメンス・BMW・コカ・コーラ・ASUSの6社が、どういう形で備案しているか。<br/>
第8章で扱いる。中国事業を持つ企業にとっては、そのまま調べ物の答えになる。

**三つ目は、AI事業の経済性を実数で見る教材である。** <br/>
第6章で、上場したAIラボの監査済み決算を読みる。<br/>
売上の伸び、粗利率、そして**計算資源のコストが会計上どこに計上されているか。** <br/>
同じことをOpenAI・Anthropicについて確認することはできない。<br/>
両社とも非上場だからである。

そして、これらすべてを支える方法が一つある。
...
**この本には、ステークホルダーとしてのポジショントークをする必要もなく、それらを守るべき立場でもない。**
...
欠番ではない。<br/>
備案時間の順（3月11日→3月18日→3月14日→3月18日→3月20日）で配列されており、**日付順を優先した結果、序号が前後している。**
...
本書はこれを補正せず、**原表の列位置のまま**扱う。<br/>
補正は解釈であり、転記ではないからである。
...
上海汉枢科技（Shanghai Hanshu Technology・美団 / Meituan系）は5件を登録している。<br/>
「LongCatdp」「LongCatVL」「LongCatS」「LongCatT2I」「LongCatT2V」。
...
前章まで、名簿の読み方と、そこに並ぶ順序を見てきた。<br/>
本章は、**名簿を業種別に読み替える。**

日本語圏の記事に現れる10社前後は、いずれも「AIを売る会社」である。<br/>
988件の残りには、**「AIを使う側」が大量に含まれている。** <br/>
そちらのほうが、実装の実態を語る。
...
**日本で言えば、JERA・NTT・JR・日本郵船・日本軽金属が、それぞれ自社の大規模モデルを持ち、国に登録している状態である。**

既存の「中国AIモデル」の記事に、この11件は一社も現れない。<br/>
記事が不正確だからではない。<br/>
**これらのモデルは海外から使えないため、APIで叩いて比較する形式の記事には構造的に入りない。**

---

## 業種別に読む ── 自分の業界はどこにあるか

以下は、名簿から業種別に抜き出した実装事例である。<br/>
**自分の業界の行を探して読んでいただきたい。** <br/> 
序号を控えれば、附件から原典を確認できる。
...
**製造業の実装は、対話アシスタントではない。** <br/>
転炉の制御、鉱山の安全管理、素材の生産。<br/>
**プロセスそのものに入っている。**
...
**水道局がコールセンターにAIを入れ、当局に登録している。** <br/>
日本の公益事業者で、同種の実装を公表している例は多くない。
...
**病院そのものが備案単位になっている。** <br/>
ベンダーが代行しているのではなく、医療機関が自らサービス提供者として登録している。<br/>
褥瘡管理（PressGuard）は、その具体性の高さが特徴である。
...
**災害対応、労働組合、市民ホットライン、通信社。** <br/>
行政と公共部門が、直接の提供者として名簿に載っている。
...
- 同済大学（Tongji University・序号897）
- 西安交通大学（Xi'an Jiaotong University・序号768）
- 中国農業大学（China Agricultural University・序号617「神農」）
- 西藏大学（Tibet University・序号840）
- 浙江工商大学（Zhejiang Gongshang University・序号818）
- 山東財経大学（Shandong University of Finance and Economics・序号779）
- 西南財経大学（Southwestern University of Finance and Economics・序号923「経綸」）
- 北京中医薬大学（Beijing University of Chinese Medicine・序号844）
- 青海師範大学（Qinghai Normal University・序号775）
- 哈爾濱工業大学（Harbin Institute of Technology・登記序号310）
- 広東外語外貿大学（Guangdong University of Foreign Studies・登記序号393）。
...
これは日本企業のAI導入計画にも示唆がある。<br/>
**基盤モデルを一つ選んで終わりではなく、用途ごとに実装が積み上がる形が、先行する市場で起きている実際の姿である。**
...
| 更新契機 | 見直す対象 | 周期 |
| --- | --- | --- |
| CAC附件の新規公表 | 付録の名簿、第1章の件数、第4章の属地分布、**序章の実数（988件・983件）** | **2ヶ月（当局の公表周期に同期）** |
| 上場企業の決算開示 | 第6章 | 四半期 |
...
なお、冒頭の一文（"under 1%"）は分母の増加に対して更新を要さない。<br/>
備案は累計値であり減少しないため、分母が増えるほどこの記述は強くなる方向にしか動かない。<br/>
**精密な実数は本文が、更新不要の要約は冒頭が担う。**
...
本章は、第1章から第6章までに提示した一次資料を再構成したものであり、新たな出典を導入していない。<br/>
各軸の根拠は以下に対応する。
...
本書はここまで、中国の名簿を読んできた。<br/>
本章は、**日本で仕事をしている読者が、そこから何を持ち帰れるか**を書く。

---

## 1. PoC止まり論への、一次資料からの反証

日本で生成AIを議論すると、必ず同じ壁の話になる。<br/>
「PoCは通るが本番に入らない」「効果は出たが基幹業務では使えない」。

この議論には、比較対象が欠けている。<br/>
**他国では本当に本番に入っているのか。入っているとしたら、どの業務か。**

名簿は、この問いに一次資料で答える。

第4章で見たとおり、988件には転炉制御、鉱山の安全管理、水道局のコールセンター、市民ホットライン、褥瘡管理、災害対応が含まれる。<br/>
**対話アシスタントでも社内文書検索でもない。プロセスと公共サービスそのものだ。**

ここから引き出せる論点は二つである。

* **第一に、実装は「AIを売る会社」ではなく「AIを使う側」で起きている。** 
名簿の大半は、AIベンダーではなく事業会社・病院・行政機関である。<br/>
日本のAI議論がベンダーの製品比較に偏っているとすれば、見ている場所が違う。

* **第二に、実装は用途ごとに積み上がっている。**
ビッグテックですら、直近の登録は音声・セキュリティ・端末向けといった垂直特化である。<br/>
基盤モデルを一つ選定して全社展開するのではなく、用途単位で個別に立ち上がっている。

ただし、**ここには重大な留保がある。**

備案は「登録した」以上のことを語らない。<br/>
**そのサービスが実際にどれだけ使われているか、成果が出ているかは、名簿からは一切分からない。** <br/>
登録が実装の成功を意味しないことは、終章で改めて述べる。

言えるのは、「日本にはない業務領域でAIが提供されている記録が、公的な名簿として存在する」ところまでである。<br/>
**それだけでも、PoC止まり論の比較対象としては十分に強い一次資料である。**

---

## 2. 中国市場に出すときの、実務の先例

中国事業を持つ企業にとって、名簿はもっと直接的な資料になる。
...
ここから読み取れる実務上の事実は、三点である。

**第一に、備案の主体は現地法人である。** <br/>
6社すべてが中国国内の法人名義で登録している。本社ではない。

**第二に、備案の単位はサービスである。** <br/>
「テスラのAI」ではなく「特斯拉车机语音大模型服务」という個別のサービス名で登録されている。<br/>
用途を特定して申請する形式である。

**第三に、外資であることによる別枠は存在しない。** <br/>
中国企業と同じ名簿に、同じ列構成で、通し番号で並んでいる。

そして第1章で見たとおり、備案の対象は「舆论属性または社会动员能力を有する」サービスである。<br/>
**社内利用のみで外部に提供しない機能が対象になるかは、名簿からは判定できない。** <br/>
名簿に載っているのは、対象と判断されて登録された結果だけである。

**この節は法的助言ではない。** <br/>
実際の申請要否と手続きは、中国の法令と当局の運用に基づいて専門家に確認する必要がある。<br/>
本書が提供するのは、**「同業他社・同規模の外資が、実際にどう登録しているか」という先例の所在**である。

---

## 3. AI事業の経済性を、実数で見る

第6章で読んだ数字は、日本の読者にとって別の使い道がある。

**AI事業のユニットエコノミクスを監査済みの実数で見られる教材に、本書はこの二社以外で到達できなかった。**

OpenAIもAnthropicも非上場である。売上の内訳も、粗利率も、計算資源のコスト構造も、法定開示がない。<br/>
一方、MiniMax（HKEX 00100）は監査済みの年度決算を公表している。

そこから読める構造で、最も実務的に重要なのはこれである。

**計算資源のコストは、売上原価とR&D費用に分かれて計上されている。**
...
R&D費用の増加要因を、会社は「学習に関わるクラウドサービス費用の増加」と説明している。<br/>
**R&Dは売上原価の4.3倍である。**

したがって、**公表されている粗利率25.4%は、推論だけを見た数字である。** <br/>
学習を含めた事業全体の採算ではない。

これは会計処理として不適切なわけではない。<br/>
研究開発費を売上原価に含めないのは標準的な扱いである。<br/>
**しかし、自社でAIサービスの収支計画を立てるとき、この分離を知らないまま他社の粗利率をベンチマークすると、必要な資金を大きく見誤る。**

もう一つ、事業構造の教訓がある。

MiniMaxは売上の73.0%が中国本土外、67.2%がコンシューマー向けのAI原生製品である。<br/>
智譜は本地化配置（オンプレミス）が中心で、企業向け・政府向けが主体だと報じられている。

**同じ日に名簿に載った二社が、同じ月に上場して、正反対の収益構造を持っている。**

「AI企業のビジネスモデル」という単一の型は存在しない。<br/>
**海外コンシューマーで伸ばす道と、国内エンタープライズで伸ばす道は、必要な組織も、資金の使い方も、リスクも異なる。** <br/>
どちらを選ぶかは、技術ではなく事業設計の問題である。

---

## 4. そして、日本には名簿がない

最後に、本書を書いていて最も強く感じたことを一つだけ書く。

**日本について、これに対応する記録を本書は確認できなかった。**

どの企業が、どの業務に、いつ生成AIを実装したのか。<br/>
国単位で全数を把握する公的な仕組みを、日本・米国・EUのいずれについても、本調査の範囲では確認できなかった。

中国の名簿は、規制のために作られたものだ。<br/>
表現の管理を目的としており、産業振興のための統計ではない。<br/>
**その目的に賛同するかどうかは、また別の問題である。**

しかし結果として、**中国は自国のAI実装を全数で観測できる状態**にある。<br/>
そして日本の企業は、自国の実装状況を知るために、アンケート調査と事例集に頼っている。

観測できないものは、改善できない。<br/>
**この非対称は、技術力の差ではなく、記録の設計の差である。**
...
**名簿に載っている実装が成功しているかどうかを、本書は一切検証していない。** <br/>
転炉制御のモデルが実際に稼働率を上げたのか、市民ホットラインの応答品質が改善したのか、名簿は何も語らない。<br/>

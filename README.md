...
> 公表されている。日本語圏で語られる中国AIモデルは、このうち10社前後である。
> 残りには製鉄所の転炉制御、水道局のコールセンター、市民ホットライン、
> ラオス語の基盤モデルがあり、テスラ上海・IKEA・シーメンス・BMW・
> コカ・コーラも同じ名簿に載っている。属地欄には省でも直轄市でもない
> 「国资委」という区分があり、備案番号が `ZhongYangQiYe-` で始まる中央企業
> 11件が、石油・電力・通信・電子科技・エネルギーの基幹企業として並ぶ。
> 中心命題：**この産業は、企業では数えられていない。名簿で数えられている。**
>
...
**988。** 2026年6月30日時点で、中国国家インターネット情報弁公室（CAC）への備案（登録）を完了した生成AIサービスの累計件数である。**598。** 同じ時点で登記を完了した生成AIアプリケーションおよび機能の累計件数である。

この二つは推計ではない。CACが2026年7月10日に公告した数字であり、**個社名入りの名簿が2ヶ月ごとに公開されている。** 2024年4月から2026年6月まで、12回分の附件が一枚のページに集約され、序号・属地・大模型名称・備案単位・備案編号・備案時間の6列が並ぶ。

日本語圏で「中国のAIモデル」が語られるとき、現れる名前はおおむね決まっている。DeepSeek、Qwen、Kimi、GLM、MiniMax。だが988件の中には、それ以外の980件あまりがある。**製鉄所の転炉を制御するモデル、水道局のコールセンター、市民ホットライン、褥瘡管理の支援、ラオス語の基盤モデル。** そして、テスラ上海・IKEA中国・シーメンス中国・コカ・コーラ上海・BMW中国も、中国企業と同じ名簿に、同じ形式で登録されている。

属地欄には、省でも直轄市でもない区分が一つある。**「国资委」**——国務院国有資産監督管理委員会である。この属地を持つ行は、備案編号が例外なく `ZhongYangQiYe-` で始まる。**中央企業は所在地ではなく管轄で登録される。** 該当は全期間で11件。中国石油天然気集団、国家石油天然気管網集団、中国電力科学研究院、中国電科集団（CETC）、中鋁集団、国家能源集団——石油・ガス管網・電力・電子科技・アルミ・エネルギーという国家インフラの基幹企業が、自前の大規模モデルを登録している。既存の「中国AIモデル」の記事に、この11件は一社も現れない。

順序にも、通説とのずれがある。備案の起点は2023年8月31日で、同日に8件が並ぶ。百度、智譜、ByteDance、百川、**中国科学院自動化研究所**、MiniMax、SenseTime、**上海AI Lab**。国家研究機関が初日から入っている。一方、**DeepSeekは序号152、2024年5月13日である。** 智譜の76倍、Moonshotの9.5倍遅い。世界がこの産業を発見した順番と、この産業が自国で登録されてきた順番は一致していない。

そして開示の側では、通説が逆転している。**智譜（HKEX 2513）とMiniMax（HKEX 00100）は2026年1月に香港上場を果たし、監査済みの年度決算を公表している。** MiniMaxの2025年度は売上US$79.0百万（+158.9%）、粗利率25.4%、うち**73.0%が中国本土外**。最大の計算資源支出は売上原価ではなくR&D費用（US$252.8百万・売上原価の4.3倍）に計上されており、**粗利率25.4%は推論だけを見た数字である。** 同じことをOpenAI・Anthropicについて確認することはできない。両社とも非上場であり、Anthropicの目論見書は本書執筆時点で未公表である。

中心命題は一つである。**この産業は、企業では数えられていない。名簿で数えられている。**

なお本書は、一次資料に到達できなかったものを扱わない。各モデルの技術的性能の比較、ベンチマークスコアの検証、多くの企業の学習チップ、iFlytek「星火」およびSenseTime「大装置」の計算基盤の販売形態、各モデルの日本語性能の独立測定——いずれも主題に関わるが、測定者・測定日・バージョンの三点が揃った公開データが存在しないか、企業側が公表していない。**到達できなかったものを、到達したかのように書かない。**
